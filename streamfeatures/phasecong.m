...
%
%
% Note that functions NONMAXSUP, HYSTHRESH and DISPFEAT can be obtained
% from my web site. BWMORPH is a function in the MATLAB image processing
% library.
%
%
...
imagefft = fft2(single(im));                    % Fourier transform of image  %heidi
sze = size(imagefft);
rows = sze(1);
cols = sze(2);
zero = zeros(sze);
