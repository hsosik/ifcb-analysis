...
classpath = '\\queenrose\ifcb_data_mvco_jun06\class2009_24may07\'; %USER set
...
streampath = [basedir 'IFCB1_2009_229\']; %USER set, which year / day to analyze
stitchpath = '\\queenrose\ifcb_data_mvco_jun06\stitch2009\';  %%USER set, roi stitch info files
class_filestr = '_class_24May07'; %USER set, string appended on roi name for class files

filelist = dir([streampath 'IFCB1_2009_229_*.roi']);
