...
for count = 1:length(mode_list),
    ...
    switch annotate_mode
        ...
        case 'ciliates'
            [~, class_cat] = intersect(class2use_here, {'Ciliate mix' 'Didinium' 'Euplotes sp' 'Laboea strobila' 'Leegaardiella ovalis' 'Mesodinium' 'Pleuronema' 'Strobilidium'...
                'Strombidium capitatum' 'Strombidium conicum' 'Strombidium inclinatum' 'Strombidium sp1' 'Strombidium sp2' 'Strombidiumn oculatum'...
                'Strombidium wulffi' 'Tiarina fusus' 'Tintinnid' 'Tontonia appendiculariformis' 'Tontonia gracillima'...
                'Eutintinnus' 'Favella' 'Helicostomella subulata' 'Stenosemella sp1' 'Stenosemella pacifica' 'Tintinnidium mucicola'...
                'Tintinnopsis' 'Balanion'});
        case 'ditylum'
        ...
        case 'big ciliates'
            [~, class_cat] = intersect(class2use_here, {'Tintinnid' 'Laboea strobila' 'Eutintinnus' 'Favella' 'Helicostomella subulata' 'Stenosemella sp1' 'Stenosemella pacifica' 'Tintinnidium mucicola'...
                'Tintinnopsis'});
        case 'special big only'
            [~, class_cat] = intersect(class2use_here, {'Ceratium' 'Eucampia cornuta' 'Ephemera' 'bad' 'Dinophysis' 'Lauderia annulata' 'Licmophora' 'Phaeocystis' 'Stephanopyxis' ...
                'Coscinodiscus' 'Odontella' 'Guinardia striata' 'Tintinnida' 'Laboea strobila' 'Eutintinnus' 'Favella' 'Helicostomella subulata' 'Stenosemella sp1' 'Stenosemella pacifica' 'Tintinnidium mucicola'...
