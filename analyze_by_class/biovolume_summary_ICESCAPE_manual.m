...
%ml_analyzed_mat = classcount;
    for filecount = 1:length(filelist),
        ...
        if ~isequal(class2use_manual, class2use_manual_first)
            ...
            if isequal(class2use_manual, class2use_manual_first(1:length(class2use_manual))),
...
save([resultpath 'summary\count_biovol_manual_' datestr], 'matdate', 'ml_analyzed', 'classcount', 'classbiovol', 'filelist', 'class2use', 'metadata', 'classcarbon')
