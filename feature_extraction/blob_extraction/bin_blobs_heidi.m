...
archive = [out_dir filesep file '_blobs_v2.zip'];
...
try
    ...
    targets = get_rois([in_dir filesep file]);
...
for i = 1:nt,
    ...
    png_path = [png_dir filesep file sprintf('_%05d.png',targets.targetNumber(i))];
