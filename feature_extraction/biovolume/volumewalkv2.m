...
%this is Heidi's implementation as of 15 Mar 2015
%this is simpler and also corrects the 1-pixel error in the earlier version of this script 
%(in that case max - min position was used when max-min+1 should have been used.
[~,~,C] = find(sum(image > 0)); 
C = C/2;
