...
[headers, pos] = textscan(csv_data,'%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s',1,'Delimiter',',');
cols = textscan(csv_data(pos+1:end), '%d %n %n %n %n %n %n %n %n %d %d %d %d %d %n %q %q %d','Delimiter',',');
