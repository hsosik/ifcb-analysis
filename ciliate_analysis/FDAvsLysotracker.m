...
figure;
plot( Lysotracker_conc, FDA_conc, 'k.', 'markersize', 10);
hold on
errorbar( Lysotracker_conc, FDA_conc, FDA_ci(1,:), FDA_ci(2,:), 'k', 'Marker', 'none', 'LineStyle', 'none' );
herrorbar(Lysotracker_conc,FDA_conc,Lysotracker_ci(1,:),Lysotracker_ci(2,:), '+k') 
axis square
