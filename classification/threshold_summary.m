load \\sosiknas1\IFCB_products\MVCO\Manual_fromClass\summary\summary_allTB_bythre_Laboea
m = load('\\sosiknas1\IFCB_products\MVCO\Manual_fromClass\summary\count_manual_current'); 
