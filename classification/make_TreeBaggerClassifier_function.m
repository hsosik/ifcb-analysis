function [ ] = make_TreeBaggerClassifier_function( result_path, train_filename, result_str, nTrees)
%function [ ] = make_TreeBaggerClassifier_function( result_path, train_filename, result_str, nTrees )
%For example:
%   make_TreeBaggerClassifier_function( 'C:\work\IFCB\user_training_test_data\manual\summary\', 'UserExample_Train_06Aug2015', 'UserExample_Trees_', 100)
