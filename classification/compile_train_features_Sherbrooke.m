...
manualpath = '/Volumes/TOSHIBA EXT/whoi_data/output_manual_classify/'; % manualt annotation files
...
%this presume all the files have the same class to use
...
save([manualpath 'summary/test_training_nov2013'], 'train', 'class_vector', 'targets', 'class2use', 'nclass', 'featitles');
