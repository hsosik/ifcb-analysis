...
manualpath = 'C:\IFCB\manual\'; % manual annotation files
feapath_base = 'C:\IFCB\features\';
...
maxn = 50; %maximum number of images per class to include
...
save([manualpath filesep 'summary' filesep 'TAMUG_Train_' datestring], 'train', 'class_vector', 'targets', 'class2use', 'nclass', 'featitles');
