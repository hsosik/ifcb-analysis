...
load(['/Volumes/TOSHIBA EXT/whoi_data/output_manual_classify/summary/test_training_nov2013']);
...
%add better path
save(['/Volumes/TOSHIBA EXT/whoi_data/output_manual_classify/summary/Sherbrooke_trees_test'],'b', 'targets', 'featitles', 'classes', 'maxthre')
