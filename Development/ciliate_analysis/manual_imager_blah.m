...
normal_ciliate_bin=[Ciliate_mix_classcount_norm 0];
...
alt_ciliate_bin=[Ciliate_mix_classcount_alt 0];
[alt_ci] = poisson_count_ci(alt_ciliate_bin, 0.95);
alt_ci_low=alt_ci(:,1);
alt_ci_upper=alt_ci(:,2);

microscope_count = [250 0];
...
figure
h = bar('v6', b);
set(gca, 'linewidth', 24, 'fontsize', 18,'fontname', 'arial')
