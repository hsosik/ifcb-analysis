...
load '/Volumes/IFCB014_OkeanosExplorerAug2013/data/Manual_fromClass/summary_old/alt_summary_old/count_manual_highhigh_green05Feb2014.mat'
...
lower=[IFCB10_ci_ml(1) IFCB10_ci_ml_gyro(1) low_green_ci_ml(1) low_green_ci_ml_gyro(1) high_green_ci_ml(1) high_green_ci_ml_gyro(1)];
upper=[IFCB10_ci_ml(2) IFCB10_ci_ml_gyro(2) low_green_ci_ml(2) low_green_ci_ml_gyro(2) high_green_ci_ml(2) high_green_ci_ml_gyro(2)];
 

lower=[ciliate_bin_perml_IFCB10-IFCB10_ci_ml(1) gyro_bin_perml_IFCB10-IFCB10_ci_ml_gyro(1) ciliate_bin_perml_low_green-low_green_ci_ml(1) ciliate_bin_perml_high_green-high_green_ci_ml(1) gyro_bin_perml_low_green-low_green_ci_ml_gyro(1) gyro_bin_perml_high_green-high_green_ci_ml_gyro(1)];
upper=[IFCB10_ci_ml(2)-ciliate_bin_perml_IFCB10 IFCB10_ci_ml_gyro(2)-gyro_bin_perml_IFCB10 low_green_ci_ml(2)-ciliate_bin_perml_low_green high_green_ci_ml(2)-ciliate_bin_perml_high_green low_green_ci_ml_gyro(2)-gyro_bin_perml_low_green high_green_ci_ml_gyro(2)-gyro_bin_perml_high_green];
