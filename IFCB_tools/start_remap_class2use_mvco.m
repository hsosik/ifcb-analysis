...
config.remappath = '\\SOSIKNAS1\IFCB_products\IFCB14_Dock\Manual_fromClass_test\'; %USER indicate path that contains all manual annotation files to be remapped
