...
config = load('class2use_MVCOmanual4', 'class2use'); %USER load YOUR class2use list from a file; format class2use = {'classstr1', 'classstr2', ...};
...
remap_class2use_auto_post_remove_ciliate_sub(config) % second to remap auto after remove ciliate subdiv
