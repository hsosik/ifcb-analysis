...
remap_set = struct('in_class', {{'Eucampia_groenlandica'}, {'Guinardia'}, {'ciliate'}, {'Strobilidium_morphotype2'}, {'Strombidium_caudatum'}},...
    'out_class', {'Cerataulina', 'Guinardia_delicatula', 'Ciliate_mix', 'Strobilidium_morphotype1', 'Tontonia_appendiculariformis'});  %Ciliate_mix case ONLY for instances without subdivide info for ciliate
