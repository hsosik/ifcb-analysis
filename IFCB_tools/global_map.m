...
exportgraphics(gcf,'c:\work\IFCB_products\Global_map\IFCB_samples_global_map_transparent.emf','ContentType','vector','BackgroundColor','none')
...
exportgraphics(gcf,'c:\work\IFCB_products\Global_map\IFCB_time_series_USA_transparent2.emf','ContentType','vector','BackgroundColor','none')
